...
const BOT_USERNAME = 'Treahkoufxs3674_bot';
...
const Invite = () => {
    ...
    const handleAddFriend = () => {
        if (!link) return;
        const shareUrl = `https://t.me/share/url?url=${encodeURIComponent(link)}&text=${encodeURIComponent('Присоединяйся ко мне в игре!')}`;
